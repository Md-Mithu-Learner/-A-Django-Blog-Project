...
def sign_up(request, *args, **kwargs):
    ...
    return render(request, 'App_Login/signup.html', context=response)
...
@login_required
def pass_change(request, *args, **kwargs):
...
@login_required
def add_profile_pic(request, *args, **kwargs):
    form = ProfilePic()
    if request.method == 'POST':
...
@login_required
def change_pro_pic(request, *args, **kwargs):
